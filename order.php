...
<main class="order container">
    ...
    <section class="row section2">
        ...
        <div class="row row2 fresh-product">
            ...
            <p class="item col1 last-row subtotal-text">Fresh Product Subtotal</p>
            <p class="item col2 last-row"></p>
            <p class="item col3 last-row subtotal-num">$6.99 pkg.</p>
        </div>
    </section>
